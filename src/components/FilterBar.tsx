...
export default function FilterBar({ searchQuery, setSearchQuery, statusFilter, setStatusFilter, warningFilter, setWarningFilter, categoryFilter, setCategoryFilter }: FilterBarProps) {
  return (
    ...
    */
    <section className="bg-indigo-950 p-5 rounded-2xl border border-indigo-900 shadow-md mb-6 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center space-x-2 bg-white border border-transparent rounded-xl px-3.5 py-2 shadow-sm focus-within:ring-4 focus-within:ring-indigo-500/30">
          <span className="text-[11px] font-bold text-indigo-500 uppercase tracking-wider">📁 Ngành nghề:</span>
          <select
        ...
        <button
          ...
          className={`flex items-center space-x-1.5 px-4 py-2.5 rounded-xl text-xs font-bold shadow-sm border transition-all ${warningFilter
